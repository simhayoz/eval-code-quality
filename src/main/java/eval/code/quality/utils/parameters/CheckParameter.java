...
public class CheckParameter extends RunParameter<List<Check>> {
    ...
    private final static Map<String, Function<ContentProvider, Check>> allPossibleCheck = Map.of("blank lines", BlankLines::new, "braces", Braces::new, "indentation", Indentation::new, "naming", Naming::new);
